...
$('#index').load('https://docs.google.com/document/d/1k3biFYoYHGzKlaZZW5UnwQeTNY9Q74P8TaH_wuWMfhA/pub?embedded=true', null, function () {
    $("style").remove();
    $("a").each(function () {
...
if (QueryString["doc"] == null)
    QueryString["doc"] = "1-1071kKHjTSqWz-S1MPG1q77hjETglA434-tigdydUdO8";
